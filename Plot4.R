...
setwd("~/Desktop/Data_Science/Exploratory Data Analysis")
...
#Format the 2x2 matrix
par(mfrow=c(2,2))

#insert the code from Plots 1, 2, and 3
# Plot 1
...
lines(powerDT[, dateTime], powerDT[, Sub_metering_2], 
      col="red")
lines(powerDT[, dateTime], powerDT[, Sub_metering_3],
      col="blue")
legend("topright", 
